...
import { useUser as useUserHook, UserAuthHookResult } from './auth/use-user';
...
export interface FirebaseServicesAndUser extends UserAuthHookResult {
...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const { user, profile, isUserLoading, userError } = useUserHook(auth, firestore);
